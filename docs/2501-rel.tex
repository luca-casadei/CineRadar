...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Codice: stringa (non vuota)
			\item Titolo: stringa
			\item EtaLimite: intero positivo
			\item Trama: stringa
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item DataDebuttoCarriera: data
			\item NomeArte: stringa
		\end{itemize}
		\item Vincoli di Tupla: Nessuno
		\item Vincoli di Chiave: Codice
	\end{itemize}
	...
	\begin{itemize}
		\item Vincoli di Dominio:
		\begin{itemize}
			\item Voto: intero compreso tra 1 e 5
		\end{itemize}
		\item Vincoli di Tupla: Nessuno
	...
	\begin{itemize}
		\item Vincoli di Dominio:
		\begin{itemize}
			\item Numero: intero positivo
			\item Tipo: stringa
			\item Titolo: stringa
			\item AnnoUscita: intero positivo
			\item Descrizione: stringa
			\item Chiusa: booleano
		\end{itemize}
		\item Vincoli di Tupla: Nessuno
