...
\begin{document}
	...
	\todo{TBD}
	Un utente può scrivere più di una recensione su vari film, esplicitando il titolo del film, la descrizione della recensione e la sua valutazione. Quando viene scritta una recensione vengono scelti dei voti, ciascuno per ogni sezione selezionata dall'utente.
	\begin{figure}[H]
		\centering
	...
	Gli utenti hanno la possibilità di iscriversi a una o più tessere. Una tessera è inserita da un registratore. Ciascuna tessera è caratterizzata da un numero univoco, che la identifica insieme all'utente tesserato, e da una data di rinnovo. 
	\begin{figure}[H]
		\centering
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=300pt]{ER/multimediacast.png}
		\caption{Schema ER della relazione tra multimedia e membri del cast}
	\end{figure}
	\subsection{Relazione tra multimedia e promo}
	\todo{TBD}
	Di un film vengono memorizzati i membri del cast che, tramite una generalizzazione, vengono suddivisi in regista e attore. Inoltre un film può essere soggetto ad offerte promozionali in modo diretto o per mezzo della sua categoria. 
	\begin{figure}[H]
		\centering
	...
	\end{figure}
	\subsection{Relazione tra utenza, cinema e tessera}
	\todo{TBD}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=300pt]{ER/utenzacinematessera.png}
		\caption{Schema ER della relazione tra utenza, cinema e tessera.}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=400pt]{ER/utenzacinematesserarecensione.png}
