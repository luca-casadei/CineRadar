...
\begin{itemize}
	...
	\item \textbf{CATEGORIZZAIONE{\_}FILM}(\underline{NomeGenere}:GENERE, \underline{CodiceFilm}:FILM)
	...
	\item \textbf{VALUTEZIONE{\_}SERIE}(\underline{UsernameUtenteValutato}:RECSERIE, \underline{CodiceRecSerie}:RECSERIE, \underline{UsernameUtente}:UTENTE, Positiva)
