...
\begin{document}
	...
	\todo{DA QUESTO PUNTO SONO DA RICONTROLLARE}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|llll|}
			...
			Concetto                   & Costrutto             & Accesso 		& Tipo	\\ \hline
			RECFILM					   & E					   & 1				&   L   \\ \hline
			recfilm.sez				   & R					   & 5				& 	L   \\ \hline
			SEZIONE					   & E  				   & 5 				&   L   \\ \hline
			\rowcolor[HTML]{CBCEFB} 
			\multicolumn{4}{|l|}{\cellcolor[HTML]{FFCE93}\textbf{Totale}: 11L} \\ \hline
		\end{tabular}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|llll|}
			...
			\rowcolor[HTML]{CBCEFB} 
			\multicolumn{4}{|l|}{\cellcolor[HTML]{FFCE93}\textbf{Totale}: 1L + 1S} \\ \hline
		\end{tabular}
	\end{table}
