...
\begin{itemize}
	...
	\begin{itemize}
		\item Vincoli di Dominio:
			\begin{itemize}
				...
				\item NumeroVisualizzati: INT (non null)
			\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Titolo: VARCHAR(50) (non null)
			\item Descrizione: VARCHAR(500) (non null)
			\item VotoComplessivo: INT compreso tra 1 e 5 (non null)
		\end{itemize}
		\item Vincoli di Tupla: Nessuno
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Voto: INT compreso tra 1 e 5 (non null)
		\end{itemize}
		\item Vincoli di Tupla: Nessuno
