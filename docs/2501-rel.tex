...
\subsection{Visualizzare l’elenco delle serie TV con la relativa durata complessiva e il numero di episodi complessivo, in base all’età di chi lo richiede. (Op. 4.3)} \label{ss:op43}
\begin{figure}[H]
	\centering
	\includegraphics{ER/navigazione/elencoserietv.png}
...
\begin{figure}[H]
	\centering
	\includegraphics{ER/navigazione/infoserietv.png}
	\caption{Schema di navigazione - Visualizzare elenco serie tv in base all'età}
\end{figure}
...
\subsubsection{Operazioni interessate:}
\begin{itemize}
	\item Op. 4.3: Visualizzare l’elenco delle serie TV con la relativa durata complessiva e il numero di episodi complessivo, in base all’età di chi lo richiede.
...
\end{itemize}
Complessivamente quindi, abbiamo $ 41.250.100 + 2.250 = 41.252.350$ accessi complessivi.
\subsubsection{Tabelle degli accessi con ridondanza:}
Consideriamo il caso in cui si introducano due attributi ridondanti "DurataComplessiva" e "NumeroEpisodi" sull'entità "SERIE", questi attributi servono per dichiarare la durata complessiva(quindi la sommatoria della durata di ciascun episodio) di una serie tv e il numero complessivo di episodi che la compongono.
\begin{itemize}
	\item Per operazione 4.3: Inserendo gli attributi ridondanti diminuiamo notevolmente gli accessi in lettura essendo che per un utente che richiede la visualizzazione dei film disponibili in base alla propria età verrà fatta 1L per l'utente stesso mentre le serie verranno controllate tutte una sola volta, quindi 2500L. Considerando la frequenza di $100/gg$ questa causerà $ 100*2501 = 250.100$ accessi complessivi al giorno.
	\item Per operazione 4.4: Questa operazione è analoga al caso senza ridondanza.
\end{itemize}

In totale si ottiene da questo studio $250.100 + 2.250 = 252.350$ accessi complessivi.
\subsubsection{Conclusioni:}
Considerando i valori ottenuti dall'analisi precedente, possiamo affermare che data la complessità $252.350 \ll 41.252.350$ conviene introdurre gli attributi ridondanti "DurataComplessiva" e "NumeroEpisodi" in SERIE.
\subsection{Attributo 4: NumeroStagioni}
\missingfigure{PARTE DI KEKKO / MARTINO}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=400pt]{ER/schemalogico/logicsx.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=400pt]{ER/schemalogico/logicdx.png}
\end{figure}
