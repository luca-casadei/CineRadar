...
In totale si ottiene da questo studio $40.000.100 + 2.250 + 110 + 80 = 40.002.540$ accessi complessivi.
\subsubsection{Conclusioni:}
Considerando i valori ottenuti dall'analisi precedente, possiamo affermare che data la complessità $40.002.540 < 41.252.445$ conviene introdurre gli attributi ridondanti "DurataComplessiva" e "NumeroStagioni" relativamente nella entità SERIE.
...
\begin{itemize}
	\item Per operazione 4.3: Quest'operazione è analoga al caso senza ridondanza se non per il fatto che non è più necessario leggere ciascuna stagione ed episodio, grazie al fatto che manteniamo salvato il numero di stagioni ed episodi tramite l'attributo ridondante in STAGIONE e SERIE. Quindi avremo in totale 2501L, che messe in relazione con la frequenza diventano 250.100 accessi in lettura al giorno.
	\item Per operazione 4.4: Quest'operazione è analoga al caso senza ridondanza.
	\item Per operazione 4.5: Per questa operazione gli accessi in scrittura aumentano dato che bisogna fare un aggiornamento nell'entità STAGIONE e EPISODIO per incrementare l'attributo ridondante "NumeroEpisodi" e "NumeroStagioni" a seguito dell'aggiunta di una STAGIONE con il relativo EPISODIO (aggiunto obbligatoriamente, data la cardinalità). 
	Quindi avremo un totale di 1L + 5S che messe in relazione con la frequenza giornaliera darà come risultato un totale di 5 accessi in lettura e 50 accessi in scrittura al giorno.
...
In totale si ottiene da questo studio $250.100 + 2.250 + 55 + 70 = 252.475$ accessi complessivi.
\subsubsection{Conclusioni:}
Considerando i valori ottenuti dall'analisi precedente, possiamo affermare che data la complessità $252.475 \ll 41.252.445$ conviene introdurre gli attributi ridondanti "NumeroEpisodi" e "NumeroStagioni" relativamente nelle entità SERIE e STAGIONE.
