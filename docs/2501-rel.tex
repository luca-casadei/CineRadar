...
\missingfigure{Da rifare l'immagine, ci sono ridondanze che vanno messe dopo}
\begin{figure}[H]
	\centering
...
\missingfigure[figcolor=yellow]{DA CONTROLLARE DA QUI}
...
\begin{itemize}
	\item Per operazione 8.1: Vedi la sottosezione \ref{ss:op81}
	\item Per operazione 5.1: Vedi la sottosezione \ref{ss:op51}
	\item Per operazione 5.2: Vedi la sottosezione \ref{ss:op52}
\end{itemize}
