...
\subsection{Visualizzare l’elenco delle serie TV con la relativa durata complessiva e il numero di episodi complessivo, in base all’età di chi lo richiede. (Op. 4.3)}
...
\subsection{Visualizzare le informazioni riguardanti una serie TV, comprese tutte le stagioni e tutti gli episodi. (Op. 4.4)}
\missingfigure{MARTINO FAI L'IMMAGINE}
