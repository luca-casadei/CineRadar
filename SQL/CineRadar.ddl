...
ALTER TABLE AMMINISTRATORE
    ADD CONSTRAINT FKtipoAmm_FK FOREIGN KEY (Username) REFERENCES ACCOUNT (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE CATEGORIZZAZIONE_FILM
    ADD CONSTRAINT FKcat_FILF FOREIGN KEY (CodiceFilm) REFERENCES FILM (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE CATEGORIZZAZIONE_FILM
    ADD CONSTRAINT FKcat_GENF FOREIGN KEY (NomeGenere) REFERENCES GENERE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE CATEGORIZZAZIONE_SERIE
    ADD CONSTRAINT FKcat_SERS FOREIGN KEY (CodiceSerie) REFERENCES SERIE (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE CATEGORIZZAZIONE_SERIE
    ADD CONSTRAINT FKcat_GENS FOREIGN KEY (NomeGenere) REFERENCES GENERE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE EPISODIO
    ADD CONSTRAINT FKcompStagione FOREIGN KEY (CodiceSerie, NumeroStagione) REFERENCES STAGIONE (CodiceSerie, NumeroStagione) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE FILM
    ADD CONSTRAINT FKcastfilm FOREIGN KEY (CodiceCast) REFERENCES CAST (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE MULTIPLO
    ADD CONSTRAINT FKpromoMul_FK FOREIGN KEY (CodiceTemplatePromo) REFERENCES TEMPLATEPROMO (CodicePromo) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE PARTECIPAZIONE_CAST
    ADD CONSTRAINT FKmem_CAS FOREIGN KEY (CodiceCast) REFERENCES CAST (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PARTECIPAZIONE_CAST
    ADD CONSTRAINT FKmem_MEM FOREIGN KEY (CodiceMembro) REFERENCES MEMBROCAST (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PREFERENZE
    ADD CONSTRAINT FKpre_UTE FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PREFERENZE
    ADD CONSTRAINT FKpre_GEN FOREIGN KEY (NomeGenere) REFERENCES GENERE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PREMI_TESSERA
    ADD CONSTRAINT FKpre_TES FOREIGN KEY (CodiceCinema, UsernameUtente) REFERENCES TESSERA (CodiceCinema, UsernameUtente) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PREMI_TESSERA
    ADD CONSTRAINT FKpre_PRO FOREIGN KEY (CodicePromoPromo, Scadenza) REFERENCES PROMO (CodiceTemplatePromo, Scadenza) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PROMO
    ADD CONSTRAINT FKvalidità FOREIGN KEY (CodiceTemplatePromo) REFERENCES TEMPLATEPROMO (CodicePromo) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PROMO_GENERE
    ADD CONSTRAINT FKpro_MUL FOREIGN KEY (CodiceTemplateMultiplo) REFERENCES MULTIPLO (CodiceTemplatePromo) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PROMO_GENERE
    ADD CONSTRAINT FKpro_GEN FOREIGN KEY (NomeGenere) REFERENCES GENERE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE RECFILM
    ADD CONSTRAINT FKrecensionefilm FOREIGN KEY (CodiceFilm) REFERENCES FILM (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE RECFILM
    ADD CONSTRAINT FKscrittRecFilm FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE RECSERIE
    ADD CONSTRAINT FKrecensioneserie FOREIGN KEY (CodiceSerie) REFERENCES SERIE (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE RECSERIE
    ADD CONSTRAINT FKscrittRecSerie FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE REGISTRATORE
    ADD CONSTRAINT FKtipoReg_FK FOREIGN KEY (Username) REFERENCES ACCOUNT (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE REGISTRATORE
    ADD CONSTRAINT FKafferenza FOREIGN KEY (CodiceCinema) REFERENCES CINEMA (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE RICHIESTA
    ADD CONSTRAINT FKeffetuazione FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE SEZIONAMENTO_FILM
    ADD CONSTRAINT FKrec_SEZF FOREIGN KEY (NomeSezione) REFERENCES SEZIONE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SEZIONAMENTO_FILM
    ADD CONSTRAINT FKrec_RECF FOREIGN KEY (UsernameUtente, CodiceRecFilm) REFERENCES RECFILM (UsernameUtente, CodiceFilm) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SEZIONAMENTO_SERIE
    ADD CONSTRAINT FKrec_RECS FOREIGN KEY (UsernameUtente, CodiceRecSerie) REFERENCES RECSERIE (UsernameUtente, CodiceSerie) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SEZIONAMENTO_SERIE
    ADD CONSTRAINT FKrec_SEZS FOREIGN KEY (NomeSezione) REFERENCES SEZIONE (Nome) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SINGOLO
    ADD CONSTRAINT FKpromoSin_FK FOREIGN KEY (CodiceTemplatePromo) REFERENCES TEMPLATEPROMO (CodicePromo) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SINGOLO
    ADD CONSTRAINT FKsinSerie FOREIGN KEY (CodiceSerie) REFERENCES SERIE (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE SINGOLO
    ADD CONSTRAINT FKsinFilm FOREIGN KEY (CodiceFilm) REFERENCES FILM (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE STAGIONE
    ADD CONSTRAINT FKcompSerie FOREIGN KEY (CodiceSerie) REFERENCES SERIE (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE STAGIONE
    ADD CONSTRAINT FKcaststagione FOREIGN KEY (CodiceCast) REFERENCES CAST (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE TESSERA
    ADD CONSTRAINT FKtesseramento FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE TESSERA
    ADD CONSTRAINT FKappartenenza FOREIGN KEY (CodiceCinema) REFERENCES CINEMA (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE UTENTE
    ADD CONSTRAINT FKtipoUsr_FK FOREIGN KEY (Username) REFERENCES ACCOUNT (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VALUTAZIONE_FILM
    ADD CONSTRAINT FKval_UTEF FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VALUTAZIONE_FILM
    ADD CONSTRAINT FKval_RECF FOREIGN KEY (UsernameUtenteValutato, CodiceRecFilm) REFERENCES RECFILM (UsernameUtente, CodiceFilm) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VALUTAZIONE_SERIE
    ADD CONSTRAINT FKval_UTES FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VALUTAZIONE_SERIE
    ADD CONSTRAINT FKval_RECS FOREIGN KEY (UsernameUtenteValutato, CodiceRecSerie) REFERENCES RECSERIE (UsernameUtente, CodiceSerie) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VISUALIZZAZIONI_EPISODIO
    ADD CONSTRAINT FKvis_EPIS FOREIGN KEY (CodiceSerie, NumeroEpisodio, NumeroStagione) REFERENCES EPISODIO (CodiceSerie, NumeroStagione, NumeroEpisodio) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VISUALIZZAZIONI_EPISODIO
    ADD CONSTRAINT FKvis_UTES FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VISUALIZZAZIONI_FILM
    ADD CONSTRAINT FKvis_UTEF FOREIGN KEY (UsernameUtente) REFERENCES UTENTE (Username) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE VISUALIZZAZIONI_FILM
    ADD CONSTRAINT FKvis_FILF FOREIGN KEY (CodiceFilm) REFERENCES FILM (Codice) ON DELETE RESTRICT ON UPDATE RESTRICT;
